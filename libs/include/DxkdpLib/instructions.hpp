 ...
 * @brief Contains hex-level headers for ingoing and outgoing instructions to the PSU.
 * @version 1.0
 * @date 2022-04-01
 * 
 * 
...
struct input_message{
     ...
     * 
     * Rather then returning a result, it sets the Check bit of the struct instance.
     */
    void Check_Bit_Calc(){
    ...
    /**
     * @brief Assembles instruction with all set bytes into the instruction member.
     * 
     */
